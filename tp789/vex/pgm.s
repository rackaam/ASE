...
;;								## 34
	...
	c0    sub $r0.7 = $r0.0, $r0.4   ## [spec] bblock 15, line 0,  t163,  0(I32),  t133
;;								## 35
	...
	c0    mov $r0.2 = $r0.7   ## [spec] bblock 15, line 0,  t162,  t163
;;								## 36
...
;;								## 0
	c0    mov $r0.61 = $r0.0   ## [spec] bblock 19, line 108,  t138,  0(SI32)
	c0    mov $r0.58 = $r0.4   ## [spec] bblock 19, line 0,  t142,  t143
	c0    mov $r0.62 = $r0.2   ## t162
	c0    mov $r0.63 = $r0.3   ## t132
;;								## 1
	c0    brf $b0.0, L39?3   ## bblock 16, line 107,  t175(I1)
;;								## 2
.trace 1
L40?3:
...
;;								## 1
	...
	c0    brf $b0.0, L41?3   ## bblock 20, line 108,  t176(I1)
;;								## 2
...
;;								## 4
	c0    ldbu.d $r0.9 = 0[$r0.59]   ## [spec] bblock 33, line 109, t63(I8), t141
;;								## 5
	c0    brf $b0.0, L42?3   ## bblock 22, line 109,  t177(I1)
;;								## 6
	c0    brf $b0.1, L43?3   ## bblock 29, line 109,  t179(I1)
;;								## 7
	c0    stb 0[$r0.8] = $r0.9   ## bblock 33, line 109, t65, t63(I8)
;;								## 8
...
;;								## 14
	c0    cmpne $b0.0 = $r0.7, 10   ## bblock 33, line 109,  t180(I1),  t69(I8),  10(SI32)
	      xnop 1
;;								## 16
	c0    brf $b0.0, L44?3   ## bblock 33, line 109,  t180(I1)
;;								## 17
...
L47?3:
	c0    cmplt $b0.0 = $r0.2, $r0.0   ## bblock 24, line 110,  t178(I1),  t48,  0(SI32)
	      xnop 1
;;								## 25
	c0    brf $b0.0, L48?3   ## bblock 24, line 110,  t178(I1)
;;								## 26
.call fprintf, caller, arg($r0.3:u32,$r0.4:u32,$r0.5:s32,$r0.6:s32), ret($r0.3:s32)
...
;;								## 3
	c0    ldw $r0.3 = 0x3c[$r0.1]  ## restore ## t132
;;								## 4
	c0    sub $r0.7 = $r0.0, $r0.4   ## bblock 15, line 0,  t163,  0(I32),  t133
;;								## 5
	c0    mov $r0.2 = $r0.7   ## bblock 15, line 0,  t162,  t163
...
;;								## 4
	c0    ldw $r0.6 = 0x34[$r0.1]  ## restore ## t134
;;								## 5
	c0    cmple $b0.1 = $r0.4, 1050   ## bblock 9, line 104,  t172(I1),  t133,  1050(SI32)
	c0    sub $r0.7 = $r0.0, $r0.4   ## [spec] bblock 15, line 0,  t163,  0(I32),  t133
;;								## 6
	c0    cmpgt $b0.2 = $r0.3, $r0.0   ## [spec] bblock 11, line 105,  t173(I1),  t132,  0(SI32)
	c0    cmple $b0.3 = $r0.3, 1500   ## [spec] bblock 13, line 106,  t174(I1),  t132,  1500(SI32)
