...
;;								## 16
	c0    ldw.d $r0.5 = 0[$r0.7]   ## [spec] bblock 43, line 79, t17, t117
...
;;								## 3
	c0    ldw $r0.5 = 12[$r0.7]   ## bblock 23, line 101, t63, t117
	      xnop 1
;;								## 5
.call fprintf, caller, arg($r0.3:u32,$r0.4:u32,$r0.5:u32), ret($r0.3:s32)
...
L5?3:
	...
	c0    ldw $r0.2 = 0x20[$r0.1]  ## restore ## t117
	      xnop 2
;;								## 2
	c0    ldw $r0.3 = 12[$r0.2]   ## bblock 27, line 87, t28, t117
	      xnop 1
;;								## 4
.call strcmp, caller, arg($r0.3:u32,$r0.4:u32), ret($r0.3:s32)
...
;;								## 5
	...
	c0    add $r0.4 = $r0.1, 0x14   ## [spec] bblock 5, line 109,  t68,  t104,  offset(width?1.6)=0x14(P32)
;;								## 6
	c0    mov $r0.2 = 2   ## [spec] bblock 41, line 88,  t118,  2(SI32)
;;								## 7
	c0    stw 0x24[$r0.1] = $r0.2  ## spill ## [spec] t118
...
L15?3:
	...
	c0    ldw $r0.2 = 0x20[$r0.1]  ## restore ## t117
	      xnop 2
;;								## 2
	c0    ldw $r0.3 = 12[$r0.2]   ## bblock 29, line 89, t34, t117
	      xnop 1
;;								## 4
.call strcmp, caller, arg($r0.3:u32,$r0.4:u32), ret($r0.3:s32)
...
;;								## 5
	...
	c0    add $r0.4 = $r0.1, 0x14   ## [spec] bblock 5, line 109,  t68,  t104,  offset(width?1.6)=0x14(P32)
;;								## 6
	c0    mov $r0.2 = 3   ## [spec] bblock 40, line 90,  t118,  3(SI32)
;;								## 7
	c0    stw 0x24[$r0.1] = $r0.2  ## spill ## [spec] t118
...
L16?3:
	...
	c0    ldw $r0.2 = 0x20[$r0.1]  ## restore ## t117
	      xnop 2
;;								## 2
	c0    ldw $r0.3 = 12[$r0.2]   ## bblock 31, line 91, t40, t117
	      xnop 1
;;								## 4
.call strcmp, caller, arg($r0.3:u32,$r0.4:u32), ret($r0.3:s32)
...
;;								## 5
	...
	c0    add $r0.4 = $r0.1, 0x14   ## [spec] bblock 5, line 109,  t68,  t104,  offset(width?1.6)=0x14(P32)
;;								## 6
	c0    mov $r0.2 = 4   ## [spec] bblock 39, line 92,  t118,  4(SI32)
;;								## 7
	c0    stw 0x24[$r0.1] = $r0.2  ## spill ## [spec] t118
...
L17?3:
	...
	c0    ldw $r0.2 = 0x20[$r0.1]  ## restore ## t117
	      xnop 2
;;								## 2
	c0    ldw $r0.3 = 12[$r0.2]   ## bblock 33, line 93, t46, t117
	      xnop 1
;;								## 4
.call strcmp, caller, arg($r0.3:u32,$r0.4:u32), ret($r0.3:s32)
...
;;								## 5
	...
	c0    add $r0.4 = $r0.1, 0x14   ## [spec] bblock 5, line 109,  t68,  t104,  offset(width?1.6)=0x14(P32)
;;								## 6
	c0    mov $r0.2 = 5   ## [spec] bblock 38, line 94,  t118,  5(SI32)
;;								## 7
	c0    stw 0x24[$r0.1] = $r0.2  ## spill ## [spec] t118
...
L18?3:
	...
	c0    ldw $r0.2 = 0x20[$r0.1]  ## restore ## t117
	      xnop 2
;;								## 2
	c0    ldw $r0.3 = 12[$r0.2]   ## bblock 35, line 95, t52, t117
	      xnop 1
;;								## 4
.call strcmp, caller, arg($r0.3:u32,$r0.4:u32), ret($r0.3:s32)
